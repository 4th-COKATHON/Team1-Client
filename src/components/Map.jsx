    ...
    <div className="relative bg-[#E9EBF0] w-full h-screen flex justify-center items-center p-3">
      <div className="w-[95%] h-[90%]">
        <div className="relative w-full h-full grid grid-cols-5 grid-rows-10 gap-3">
          {/* Row 1 */}
          <div
            className={`relative w-full h-full text-white flex items-center justify-center border border-black rounded-tl-lg ${
          ...
          <div
            className={`relative w-full h-full text-white flex items-center justify-center border border-black rounded-tr-lg ${
          ...
          {/* Row 10 */}
          <div
            className={`relative w-full h-full text-white flex items-center justify-center border border-black rounded-bl-lg ${
          ...
          <div
            className={`relative w-full h-full text-white flex items-center justify-center border border-black rounded-br-lg ${
